...
def main():
    ...
    server_group.add_argument("action", metavar="update", type=str, help="Frida server on Android", nargs="*", )
    server_group.add_argument("start", type=str, help="Frida server on Android", nargs="?")
    server_group.add_argument("stop", type=str, help="Frida server on Android", nargs="?")
    server_group.add_argument("reboot", type=str, help="Frida server on Android", nargs="?")
    ...
    if args.func == "server":
        ...
        server_route.get(args.action[0], start_server)(*args.action[1:])
